...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests().antMatchers("/user/login", "/api/member").permitAll()
				...
				.antMatchers("/student/signupStudent", "/student/searchStudentID", "/student/searchStudentPW",
						"/student/updateStudentPW")
				.permitAll()
				.antMatchers("/teacher/signupTeacher", "/teacher/searchTeacherID", "/teacher/searchTeacherPW",
						"/teacher/updateTeacherPW")
